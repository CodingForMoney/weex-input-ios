...
@interface LXTextInputView : UITextField
@property (nonatomic, assign) UIEdgeInsets border;
@property (nonatomic, assign) UIEdgeInsets padding;
@end

@implementation LXTextInputView
...
@interface LXTextInputComponent()

@property (nonatomic, strong) LXTextInputView *inputView;
@property (nonatomic, strong) WXDatePickerManager *datePickerManager;
@property (nonatomic, strong) NSDictionary *attr;
//attribute
@property (nonatomic, strong) UIColor *placeholderColor;
@property (nonatomic) WXPixelType placeholderFontSize;
...
@implementation LXTextInputComponent
{
...
- (instancetype)initWithRef:(NSString *)ref type:(NSString *)type styles:(NSDictionary *)styles attributes:(NSDictionary *)attributes events:(NSArray *)events weexInstance:(WXSDKInstance *)weexInstance
{
    ...
    if (self) {
        ...
        if (styles[@"placeholderFontSize"]) {
            _placeholderFontSize = [WXConvert WXPixelType:styles[@"placeholderFontSize"] scaleFactor:self.weexInstance.pixelScaleFactor];
        }else{
            _placeholderFontSize = WX_TEXT_FONT_SIZE;
        }
    }
...
- (UIView *)loadView
{
    _inputView = [[LXTextInputView alloc] init];
    return _inputView;
}
...
- (void)setPlaceholderAttributedString
{
    ...
    UIFont *placeholderFont = [UIFont systemFontOfSize:_placeholderFontSize];
    ...
    [attributedString addAttribute:NSFontAttributeName value:placeholderFont range:NSMakeRange(0, _placeholderString.length)];
    NSMutableParagraphStyle *style = [_inputView.defaultTextAttributes[NSParagraphStyleAttributeName] mutableCopy];
    style.minimumLineHeight = _inputView.font.lineHeight / 2 + placeholderFont.lineHeight / 2;
    [attributedString addAttribute:NSParagraphStyleAttributeName value:style range:NSMakeRange(0, _placeholderString.length)];
